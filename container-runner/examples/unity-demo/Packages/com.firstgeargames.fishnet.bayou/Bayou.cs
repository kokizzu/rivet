...
namespace FishNet.Transporting.Bayou
{
    ...
    public class Bayou : Transport
    {
       ...
       // private bool _configureFor
        ...
        /// <summary>
        /// Path and optional query used by the client WebSocket request.
        /// </summary>
        [Tooltip("Path and optional query used by the client WebSocket request.")]
        [SerializeField]
        private string _clientPath = "/";
        /// <summary>
        /// Optional WebSocket subprotocol header value.
        /// </summary>
        [Tooltip("Optional WebSocket subprotocol header value.")]
        [SerializeField]
        private string _clientSubprotocol = "";
        #endregion
        ...
        /// <summary>
        /// Sets the WebSocket path and optional query the client will connect to.
        /// </summary>
        /// <param name="path"></param>
        public void SetClientPath(string path)
        {
            _clientPath = string.IsNullOrWhiteSpace(path) ? "/" : path;
        }
        /// <summary>
        /// Sets the WebSocket subprotocol header value the client will offer.
        /// </summary>
        /// <param name="subprotocol"></param>
        public void SetClientSubprotocol(string subprotocol)
        {
            _clientSubprotocol = subprotocol ?? string.Empty;
        }
        ...
        private bool StartClient(string address)
        {
            ...
            return _client.StartConnection(address, _port, _useWss, _clientPath, _clientSubprotocol);
        }
