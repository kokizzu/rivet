...
namespace FishNet.Transporting.Bayou.Client
{
    public class ClientSocket : CommonSocket
    {
        ...
        /// <summary>
        /// WebSocket path and optional query used by the server.
        /// </summary>
        private string _pathAndQuery = "/";
        /// <summary>
        /// Optional WebSocket subprotocol header value.
        /// </summary>
        private string _subprotocol = string.Empty;
        /// <summary>
        ...
        private void Socket(bool useWss)
        {
            ...
            _client.SetSubprotocol(_subprotocol);
            ...
            UriBuilder builder = new UriBuilder
            {
                ...
                Host = _address,
                Port = _port,
                Path = GetPath(_pathAndQuery),
                Query = GetQuery(_pathAndQuery)
            };
        ...
        internal bool StartConnection(string address, ushort port, bool useWss, string pathAndQuery, string subprotocol)
        {
            ...
            _port = port;
            _address = address;
            _pathAndQuery = string.IsNullOrWhiteSpace(pathAndQuery) ? "/" : pathAndQuery;
            _subprotocol = subprotocol ?? string.Empty;
        ...
        private static string GetQuery(string pathAndQuery)
        {
            int queryStart = pathAndQuery.IndexOf('?');
            return queryStart < 0 ? string.Empty : pathAndQuery.Substring(queryStart + 1);
        }
