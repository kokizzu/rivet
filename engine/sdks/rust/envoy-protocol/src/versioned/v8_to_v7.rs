...
pub fn convert_sqlite_commit_stage_begin_request_v8_to_v7(
	x: v8::SqliteCommitStageBeginRequest,
) -> Result<v7::SqliteCommitStageBeginRequest> {
	Ok(v7::SqliteCommitStageBeginRequest {
		actor_id: x.actor_id,
		expected_generation: x.expected_generation,
		expected_head_txid: x.expected_head_txid,
	})
...
pub fn convert_sqlite_commit_stage_begin_ok_v8_to_v7(
	x: v8::SqliteCommitStageBeginOk,
) -> Result<v7::SqliteCommitStageBeginOk> {
	Ok(v7::SqliteCommitStageBeginOk { txid: x.txid })
}

pub fn convert_sqlite_commit_stage_begin_response_v8_to_v7(
	x: v8::SqliteCommitStageBeginResponse,
) -> Result<v7::SqliteCommitStageBeginResponse> {
	Ok(match x {
		v8::SqliteCommitStageBeginResponse::SqliteCommitStageBeginOk(v) => {
			v7::SqliteCommitStageBeginResponse::SqliteCommitStageBeginOk(
				convert_sqlite_commit_stage_begin_ok_v8_to_v7(v)?,
			)
		}
		v8::SqliteCommitStageBeginResponse::SqliteErrorResponse(v) => {
			v7::SqliteCommitStageBeginResponse::SqliteErrorResponse(
...
pub fn convert_sqlite_commit_stage_segment_request_v8_to_v7(
	x: v8::SqliteCommitStageSegmentRequest,
) -> Result<v7::SqliteCommitStageSegmentRequest> {
	Ok(v7::SqliteCommitStageSegmentRequest {
		actor_id: x.actor_id,
		expected_generation: x.expected_generation,
		txid: x.txid,
...
pub fn convert_sqlite_commit_stage_segment_ok_v8_to_v7(
	x: v8::SqliteCommitStageSegmentOk,
) -> Result<v7::SqliteCommitStageSegmentOk> {
	Ok(v7::SqliteCommitStageSegmentOk {
		staged_bytes: x.staged_bytes,
	})
}

pub fn convert_sqlite_commit_stage_segment_response_v8_to_v7(
	x: v8::SqliteCommitStageSegmentResponse,
) -> Result<v7::SqliteCommitStageSegmentResponse> {
	Ok(match x {
		v8::SqliteCommitStageSegmentResponse::SqliteCommitStageSegmentOk(v) => {
			v7::SqliteCommitStageSegmentResponse::SqliteCommitStageSegmentOk(
				convert_sqlite_commit_stage_segment_ok_v8_to_v7(v)?,
			)
		}
		v8::SqliteCommitStageSegmentResponse::SqliteErrorResponse(v) => {
			v7::SqliteCommitStageSegmentResponse::SqliteErrorResponse(
				convert_sqlite_error_response_v8_to_v7(v)?,
			)
		}
	})
...
pub fn convert_sqlite_commit_finalize_request_v8_to_v7(
	x: v8::SqliteCommitFinalizeRequest,
) -> Result<v7::SqliteCommitFinalizeRequest> {
	Ok(v7::SqliteCommitFinalizeRequest {
		actor_id: x.actor_id,
		expected_generation: x.expected_generation,
		txid: x.txid,
...
pub fn convert_sqlite_commit_finalize_ok_v8_to_v7(
	x: v8::SqliteCommitFinalizeOk,
) -> Result<v7::SqliteCommitFinalizeOk> {
	Ok(v7::SqliteCommitFinalizeOk {
		head_txid: x.head_txid,
	})
}

pub fn convert_sqlite_commit_finalize_response_v8_to_v7(
	x: v8::SqliteCommitFinalizeResponse,
) -> Result<v7::SqliteCommitFinalizeResponse> {
	Ok(match x {
		v8::SqliteCommitFinalizeResponse::SqliteCommitFinalizeOk(v) => {
			v7::SqliteCommitFinalizeResponse::SqliteCommitFinalizeOk(
				convert_sqlite_commit_finalize_ok_v8_to_v7(v)?,
			)
		}
		v8::SqliteCommitFinalizeResponse::SqliteErrorResponse(v) => {
			v7::SqliteCommitFinalizeResponse::SqliteErrorResponse(
				convert_sqlite_error_response_v8_to_v7(v)?,
			)
		}
	})
...
pub fn convert_to_rivet_tunnel_message_kind_v8_to_v7(
	...
	Ok(match x {
		...
		v8::ToRivetTunnelMessageKind::ToRivetResponseAbort(_) => {
			v7::ToRivetTunnelMessageKind::ToRivetResponseAbort
		}
		v8::ToRivetTunnelMessageKind::ToRivetRequestBodyWindowUpdate(_) => {
			bail!("v7 has no request body window update")
		}
		v8::ToRivetTunnelMessageKind::ToRivetRequestBodyCancel => {
			bail!("v7 has no request body cancel")
		}
...
pub fn convert_to_envoy_tunnel_message_kind_v8_to_v7(
	...
	Ok(match x {
		...
		v8::ToEnvoyTunnelMessageKind::ToEnvoyRequestAbort(_) => {
			v7::ToEnvoyTunnelMessageKind::ToEnvoyRequestAbort
		}
		v8::ToEnvoyTunnelMessageKind::ToEnvoyRequestBodyCancel => {
			bail!("v7 has no request body cancel")
		}
		v8::ToEnvoyTunnelMessageKind::ToEnvoyResponseBodyWindowUpdate(_) => {
			bail!("v7 has no response body window update")
		}
...
pub fn convert_to_rivet_sqlite_commit_stage_begin_request_v8_to_v7(
	x: v8::ToRivetSqliteCommitStageBeginRequest,
) -> Result<v7::ToRivetSqliteCommitStageBeginRequest> {
	Ok(v7::ToRivetSqliteCommitStageBeginRequest {
		request_id: x.request_id,
		data: convert_sqlite_commit_stage_begin_request_v8_to_v7(x.data)?,
	})
}

pub fn convert_to_rivet_sqlite_commit_stage_segment_request_v8_to_v7(
	x: v8::ToRivetSqliteCommitStageSegmentRequest,
) -> Result<v7::ToRivetSqliteCommitStageSegmentRequest> {
	Ok(v7::ToRivetSqliteCommitStageSegmentRequest {
		request_id: x.request_id,
		data: convert_sqlite_commit_stage_segment_request_v8_to_v7(x.data)?,
	})
}

pub fn convert_to_rivet_sqlite_commit_finalize_request_v8_to_v7(
	x: v8::ToRivetSqliteCommitFinalizeRequest,
) -> Result<v7::ToRivetSqliteCommitFinalizeRequest> {
	Ok(v7::ToRivetSqliteCommitFinalizeRequest {
		request_id: x.request_id,
		data: convert_sqlite_commit_finalize_request_v8_to_v7(x.data)?,
	})
}
...
pub fn convert_to_rivet_v8_to_v7(x: v8::ToRivet) -> Result<v7::ToRivet> {
	Ok(match x {
		...
		v8::ToRivet::ToRivetSqliteCommitStageBeginRequest(v) => {
			v7::ToRivet::ToRivetSqliteCommitStageBeginRequest(
				convert_to_rivet_sqlite_commit_stage_begin_request_v8_to_v7(v)?,
			)
		}
		v8::ToRivet::ToRivetSqliteCommitStageSegmentRequest(v) => {
			v7::ToRivet::ToRivetSqliteCommitStageSegmentRequest(
				convert_to_rivet_sqlite_commit_stage_segment_request_v8_to_v7(v)?,
			)
		}
		v8::ToRivet::ToRivetSqliteCommitFinalizeRequest(v) => {
			v7::ToRivet::ToRivetSqliteCommitFinalizeRequest(
				convert_to_rivet_sqlite_commit_finalize_request_v8_to_v7(v)?,
			)
		}
...
pub fn convert_to_envoy_sqlite_commit_stage_begin_response_v8_to_v7(
	x: v8::ToEnvoySqliteCommitStageBeginResponse,
) -> Result<v7::ToEnvoySqliteCommitStageBeginResponse> {
	Ok(v7::ToEnvoySqliteCommitStageBeginResponse {
		request_id: x.request_id,
		data: convert_sqlite_commit_stage_begin_response_v8_to_v7(x.data)?,
	})
}

pub fn convert_to_envoy_sqlite_commit_stage_segment_response_v8_to_v7(
	x: v8::ToEnvoySqliteCommitStageSegmentResponse,
) -> Result<v7::ToEnvoySqliteCommitStageSegmentResponse> {
	Ok(v7::ToEnvoySqliteCommitStageSegmentResponse {
		request_id: x.request_id,
		data: convert_sqlite_commit_stage_segment_response_v8_to_v7(x.data)?,
	})
}

pub fn convert_to_envoy_sqlite_commit_finalize_response_v8_to_v7(
	x: v8::ToEnvoySqliteCommitFinalizeResponse,
) -> Result<v7::ToEnvoySqliteCommitFinalizeResponse> {
	Ok(v7::ToEnvoySqliteCommitFinalizeResponse {
		request_id: x.request_id,
		data: convert_sqlite_commit_finalize_response_v8_to_v7(x.data)?,
	})
}
...
pub fn convert_to_envoy_v8_to_v7(x: v8::ToEnvoy) -> Result<v7::ToEnvoy> {
	Ok(match x {
		...
		v8::ToEnvoy::ToEnvoySqliteCommitStageBeginResponse(v) => {
			v7::ToEnvoy::ToEnvoySqliteCommitStageBeginResponse(
				convert_to_envoy_sqlite_commit_stage_begin_response_v8_to_v7(v)?,
			)
		}
		v8::ToEnvoy::ToEnvoySqliteCommitStageSegmentResponse(v) => {
			v7::ToEnvoy::ToEnvoySqliteCommitStageSegmentResponse(
				convert_to_envoy_sqlite_commit_stage_segment_response_v8_to_v7(v)?,
			)
		}
		v8::ToEnvoy::ToEnvoySqliteCommitFinalizeResponse(v) => {
			v7::ToEnvoy::ToEnvoySqliteCommitFinalizeResponse(
				convert_to_envoy_sqlite_commit_finalize_response_v8_to_v7(v)?,
			)
		}
